...
export const cerebroFront = {
  ...
  textos: {
    ...
    panelAdmin: {
      ...
      perfil: {
        ...
        ocultarCambioPass: "Ocultar cambio de contraseña",
        passActual: "Contraseña actual",
        passNueva: "Nueva contraseña",
        actualizarPass: "Actualizar contraseña",
        cargando: "Cargando perfil...",
        errorCargar: "No se pudo cargar el perfil.",
        errorGuardar: "No se pudo guardar el perfil.",
        exitoGuardar: "Perfil actualizado",
        exitoGuardarMensaje: "Datos guardados correctamente.",
        exitoPass: "Contraseña actualizada",
        exitoPassMensaje: "Contraseña cambiada correctamente.",
        errorPass: "Contraseña actual incorrecta o no cumple requisitos.",
        errorSubirFoto: "No se pudo subir la foto.",
        placeholderSexo: "Seleccionar sexo…",
        telefono: "Teléfono",
        placeholderTelefono: "Ingresá tu teléfono",
        rol: "Administrador",
      },
    },
    usuarios: {
      titulo: "Usuarios",
      placeholderBuscar: "Buscar por nombre, usuario o DNI...",
      filtroTodos: "Todos los estados",
      activados: "Activados",
      pendientes: "Pendientes",
      bloqueados: "Bloqueados",
      enDeuda: "En deuda",
      filtroTodosPlanes: "Todos los planes",
      ...
      escribaUsername: "Escribí el nombre de usuario",
      paraConfirmar: "para confirmar:",
      ingresePassword: "Ingresá tu contraseña de administrador:",
      cancelar: "Cancelar",
      confirmarEliminarBtn: "Eliminar",
      detalleTitulo: "Detalle del usuario",
      estadisticas: "Estadísticas",
      movimientos: "Movimientos recientes",
      resumenesMensuales: "Resúmenes mensuales",
      appsCreadas: "Apps creadas",
      tarjetasCreadas: "Tarjetas creadas",
      sinMovimientos: "Sin movimientos registrados.",
      tasaAnual: "Tasa: 40% anual",
      sinResumenes: "Sin resúmenes mensuales.",
      regalarTokens: "Regalar tokens",
      cantidadTokens: "Cantidad de tokens",
      passwordAdmin: "Contraseña de administrador",
      limiteUsuario: "Límite diario por usuario: 100 tokens",
      limiteGlobal: "Límite diario global: 5000 tokens",
      regalar: "Regalar",
      cambiarPlan: "Cambiar plan",
      planActual: "Plan actual",
      nuevoPlan: "Nuevo plan",
      soloUpgrade: "Solo se permite cambiar a un plan superior.",
      cambiar: "Cambiar",
    ...
    fondo: {
      titulo: "Fondo",
      pestanaSaldo: "Saldo",
      pestanaInversion: "Invertir",
      pestanaGoteo: "Goteo",
      pestanaAcumulado: "Acumulado",
      pestanaMovimientos: "Movimientos",
      saldoTotal: "Saldo total del fondo",
      disponibleParaInvertir: "Este monto está disponible para invertir",
      invertido: "Total invertido",
      tasaAnual: "Tasa: 40% anual",
      horarioInversion: "Operaciones permitidas entre las 15:00 y 23:59",
      placeholderInvertir: "Monto a invertir",
      invertir: "Invertir",
      gotaDiaria: "Gota diaria generada hoy",
      sinGoteo: "Aún no se ha registrado el goteo de hoy.",
      gotasAcumuladas: "Gotas acumuladas totales",
      fecha: "Fecha",
      usuarioOrigen: "Usuario",
      dniLabel: "DNI",
      cantidad: "Cantidad",
      motivo: "Motivo",
      placeholderBuscarMovimiento: "Buscar por usuario o DNI",
      buscar: "Buscar",
    ...
    registro: {
      ...
      planActual: "Plan seleccionado",
      cambiarPlan: "Cambiar plan",
      sinPlanTitulo: "No seleccionaste un plan",
      sinPlanMensaje: "Debes elegir un plan antes de registrarte.",
      sinPlanBoton: "Ver planes",
      tipoCuentaLabel: "Tipo de cuenta",
      tipoCuentaDeveloper: "Developer / Tester",
      tipoCuentaEmpresa: "Empresa",
      tipoCuentaNoDisponible: "Requiere plan Pro o Enterprise",
      tipoCuentaObligatorio: "Debes seleccionar un tipo de cuenta",
      campoNombre: "Nombre",
      campoApellido: "Apellido",
      campoUsername: "Nombre de usuario",
      campoDni: "DNI",
      campoEmail: "Correo electrónico",
      campoPassword: "Contraseña",
      campoPasswordConfirmar: "Confirmar contraseña",
      placeholderNombre: "Ingresá tu nombre",
      placeholderApellido: "Ingresá tu apellido",
      placeholderUsername: "Elegí un nombre de usuario",
      placeholderDni: "Ingresá tu DNI sin puntos",
      placeholderEmail: "tucorreo@ejemplo.com",
      placeholderPassword: "Elegí tu contraseña",
      placeholderPasswordConfirmar: "Repetí tu contraseña",
      usernameDisponible: "✓ Usuario disponible",
      usernameNoDisponible: "✗ Usuario en uso",
      usernameVerificando: "Verificando...",
      dniDisponible: "✓ DNI disponible",
      dniNoDisponible: "✗ DNI ya registrado",
      dniVerificando: "Verificando...",
      emailInvalido: "Formato de correo inválido",
      passwordDebil: "Seguridad: Débil",
      passwordMedia: "Seguridad: Media",
      passwordFuerte: "Seguridad: Fuerte",
      passwordMuyFuerte: "Seguridad: Muy fuerte",
      ...
      errorServidor: "Error interno. Intentalo de nuevo más tarde.",
      errorUsernameDuplicado: "El nombre de usuario ya está en uso.",
      errorDniDuplicado: "El DNI ya está registrado.",
      errorTipoCuentaPlan: "La cuenta empresa requiere plan Pro o Enterprise.",
      exitoTitulo: "¡Registro exitoso!",
      exitoMensaje:
        "Te enviamos un correo para activar tu cuenta. Revisá tu bandeja de entrada.",
      exitoBoton: "Ir al inicio de sesión",
      terminosTexto: "Al registrarte aceptás los",
    ...
    login: {
      ...
      tabUsuario: "Usuario",
      tabEmpleado: "Empleado",
      codigoEmpleado: "Código de empleado",
      placeholderCodigoEmpleado: "Código único de acceso",
      campoUsername: "Nombre de usuario",
      campoPassword: "Contraseña",
      placeholderUsername: "Nombre de usuario",
      placeholderPassword: "Contraseña",
      botonIngresar: "Ingresar",
      botonProcesando: "Ingresando...",
      recordarUsuario: "Recordar usuario",
      recuperarContrasena: "¿Olvidaste tu contraseña?",
      reenviarActivacion: "Reenviar email de activación",
      errorCamposVacios: "Completá todos los campos",
      errorUsuarioIncorrecto: "Usuario o contraseña incorrectos",
      errorCuentaNoActivada: "Cuenta no activada. Revisá tu correo.",
      errorCodigoInvalido: "Código de empleado inválido",
      ...
      botonVolverLogin: "Volver al inicio de sesión",
    },
  },
  ...
  estilos: {
    ...
    demoPanel: {
      ...
      // Mobile
      mobileSidebarDisplay: "none",
      mobileTopBarDisplay: "none",
      mobileTopBarBackground: "#0b0b14",
      mobileTopBarPadding: "0.5rem 1rem",
      mobileTopBarBorderBottom: "1px solid rgba(255,255,255,0.06)",
      mobileHamburguesaColor: "#ffffff",
      mobileHamburguesaSize: "1.5rem",
      mobileHamburguesaCursor: "pointer",
      mobileMenuDropdownBackground: "#0b0b14",
      mobileMenuDropdownPosition: "absolute",
      mobileMenuDropdownTop: "100%",
      mobileMenuDropdownLeft: 0,
      mobileMenuDropdownRight: 0,
      mobileMenuDropdownZIndex: 100,
      mobileMenuDropdownPadding: "0.5rem 0",
      mobileMenuDropdownBorderBottom: "1px solid rgba(255,255,255,0.06)",
      mobileSidebarBreakpoint: "768px",
    },
    registroForm: {
      contenedorMaxWidth: "700px",
      contenedorWidth: "100%",
      contenedorMargin: "0 auto",
      contenedorPadding: "2.5rem 2rem",
      contenedorBorderRadius: "24px",
      contenedorBoxShadow: "0 20px 60px rgba(0,0,0,0.15)",
      contenedorBorder: "1px solid",
      contenedorBackground: "temaActivo.fondo",
      // Cabecera con plan
      planContainerDisplay: "flex",
      planContainerAlignItems: "center",
      planContainerJustifyContent: "space-between",
      planContainerMarginBottom: "1.5rem",
      planContainerPadding: "1rem 1.2rem",
      planContainerBorderRadius: "12px",
      planContainerBackground: "temaActivo.primario + '10'",
      planContainerBorder: "1px solid temaActivo.primario + '30'",
      planLabelFontSize: "0.85rem",
      planLabelColor: "temaActivo.texto + '70'",
      planNombreFontSize: "1.2rem",
      planNombreFontWeight: "bold",
      planCambiarFontSize: "0.85rem",
      planCambiarColor: "temaActivo.primario",
      planCambiarCursor: "pointer",
      planCambiarTextDecoration: "underline",
      // Selector de tipo de cuenta
      tipoCuentaContainerDisplay: "flex",
      tipoCuentaContainerGap: "1rem",
      tipoCuentaContainerMarginBottom: "1.8rem",
      tipoCuentaOpcionFlex: 1,
      tipoCuentaOpcionPadding: "1rem",
      tipoCuentaOpcionBorderRadius: "12px",
      tipoCuentaOpcionBorder: "2px solid",
      tipoCuentaOpcionTextAlign: "center",
      tipoCuentaOpcionCursor: "pointer",
      tipoCuentaOpcionTransition: "all 0.3s ease",
      tipoCuentaOpcionBorderDefault: "temaActivo.texto + '20'",
      tipoCuentaOpcionBorderHover: "temaActivo.primario",
      tipoCuentaOpcionBorderActivo: "temaActivo.primario",
      tipoCuentaOpcionBackgroundActivo: "temaActivo.primario + '10'",
      tipoCuentaOpcionDeshabilitada: "temaActivo.texto + '15'",
      tipoCuentaOpcionDeshabilitadaTexto: "temaActivo.texto + '40'",
      tipoCuentaOpcionDeshabilitadaCursor: "not-allowed",
      tipoCuentaIconoSize: "1.8rem",
      tipoCuentaIconoMarginBottom: "0.5rem",
      tipoCuentaTituloFontSize: "1rem",
      tipoCuentaTituloFontWeight: "600",
      tipoCuentaTituloColor: "temaActivo.texto",
      tipoCuentaSubtituloFontSize: "0.75rem",
      tipoCuentaSubtituloColor: "temaActivo.texto + '60'",
      // Indicador de progreso
      progresoAltura: "4px",
      progresoBorderRadius: "4px",
      progresoBackground: "temaActivo.texto + '15'",
      ...
      validacionFontSize: "0.8rem",
      validacionMarginTop: "0.4rem",
      validacionMarginLeft: "0.5rem",
      validacionDisplay: "flex",
      validacionAlignItems: "center",
      validacionGap: "0.3rem",
      // Barra de fortaleza de contraseña
      fortalezaContainerMarginTop: "0.5rem",
      fortalezaContainerDisplay: "flex",
      fortalezaContainerGap: "0.4rem",
      fortalezaSegmentoFlex: 1,
      fortalezaSegmentoAltura: "4px",
      fortalezaSegmentoBorderRadius: "2px",
      fortalezaSegmentoBackground: "temaActivo.texto + '15'",
      fortalezaSegmentoActivoDebil: "temaActivo.error",
      fortalezaSegmentoActivoMedia: "temaActivo.advertencia",
      fortalezaSegmentoActivoFuerte: "temaActivo.info",
      fortalezaSegmentoActivoMuyFuerte: "temaActivo.exito",
      fortalezaTextoFontSize: "0.8rem",
      fortalezaTextoMarginTop: "0.3rem",
      // Checkbox términos
      terminosContainerDisplay: "flex",
      terminosContainerAlignItems: "flex-start",
      terminosContainerGap: "0.5rem",
      terminosContainerMarginBottom: "1.5rem",
      terminosCheckboxWidth: "18px",
      terminosCheckboxHeight: "18px",
      terminosCheckboxCursor: "pointer",
      terminosTextoFontSize: "0.85rem",
      terminosLinkColor: "temaActivo.primario",
      terminosLinkCursor: "pointer",
      terminosLinkTextDecoration: "underline",
      // Botón de envío
      botonWidth: "100%",
      botonPadding: "1.1rem",
      botonBorderRadius: "14px",
      ...
      modalOverlayDisplay: "flex",
      modalOverlayAlignItems: "center",
      modalOverlayJustifyContent: "center",
      modalOverlayPosition: "fixed",
      modalOverlayTop: 0,
      modalOverlayLeft: 0,
      modalOverlayRight: 0,
      modalOverlayBottom: 0,
      modalOverlayZIndex: 2000,

      // Bordes neón para modales (colores del tema activo)
      modalNeonExitoBorder: "2px solid temaActivo.exito",
      modalNeonExitoShadow: "0 0 15px temaActivo.exito60",
      modalNeonErrorBorder: "2px solid temaActivo.error",
      modalNeonErrorShadow: "0 0 15px temaActivo.error60",
      modalNeonAdvertenciaBorder: "2px solid temaActivo.advertencia",
      modalNeonAdvertenciaShadow: "0 0 15px temaActivo.advertencia60",
      modalNeonInfoBorder: "2px solid temaActivo.info",
      modalNeonInfoShadow: "0 0 15px temaActivo.info60",
      modalContenedorBackground: "temaActivo.fondo",
      modalContenedorPadding: "2rem",
      modalContenedorBorderRadius: "16px",
      modalContenedorMaxWidth: "400px",
      modalContenedorWidth: "90%",
      modalContenedorTextAlign: "center",
      modalContenedorBoxShadow: "0 20px 40px rgba(0,0,0,0.3)",
      modalIconoSize: "3rem",
      modalIconoMarginBottom: "1rem",
      modalTituloFontSize: "1.3rem",
      modalTituloFontWeight: "bold",
      modalTituloMarginBottom: "0.5rem",
      modalMensajeFontSize: "0.95rem",
      modalMensajeColor: "temaActivo.texto + '80'",
      modalMensajeMarginBottom: "1.5rem",
      modalBotonPadding: "0.8rem 2rem",
      modalBotonBorderRadius: "10px",
      modalBotonBorder: "none",
      modalBotonBackground: "temaActivo.primario",
      modalBotonColor: "#FFFFFF",
      modalBotonFontWeight: "600",
      modalBotonCursor: "pointer",
      // Modal éxito
      exitoContainerTextAlign: "center",
      exitoContainerPadding: "2rem 1rem",
      exitoIconoSize: "4rem",
      exitoIconoColor: "temaActivo.exito",
      exitoIconoMarginBottom: "1rem",
      exitoTituloFontSize: "1.5rem",
      exitoTituloFontWeight: "700",
      exitoTituloMarginBottom: "0.5rem",
      exitoMensajeFontSize: "1rem",
      exitoMensajeColor: "temaActivo.texto + '80'",
      exitoMensajeMaxWidth: "400px",
      exitoMensajeMargin: "0 auto 2rem",
      exitoBotonPadding: "0.8rem 2rem",
      exitoBotonBorderRadius: "10px",
      exitoBotonBorder: "none",
      exitoBotonBackground: "temaActivo.primario",
      exitoBotonColor: "#FFFFFF",
      exitoBotonFontWeight: "600",
      exitoBotonCursor: "pointer",
      // Responsive
      mobilePadding: "1.5rem 1rem",
      mobileTituloFontSize: "1.8rem",
    },
  },
};
